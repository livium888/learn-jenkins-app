    ...
    NavHost(navController = navController, startDestination = ROUTE_LIBRARY) {
        ...
        composable(ROUTE_REVIEW) {
            val viewModel: ReviewViewModel = viewModel(
                factory = viewModelFactory { initializer { ReviewViewModel(app.termRepository, app.libraryRepository, app.readingCheckRepository, app.questionFeedback) } },
            )
        ...
        composable(ROUTE_STATS) {
            val viewModel: StatsViewModel = viewModel(
                factory = viewModelFactory { initializer { StatsViewModel(app.termRepository, app.calibration, app.readingCheckRepository, app.reviewHistory, app.backupRepository, app.questionFeedback, app.libraryRepository) } },
            )
            StatsScreen(
                viewModel = viewModel,
